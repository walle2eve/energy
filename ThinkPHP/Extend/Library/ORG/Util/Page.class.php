...
class Page extends Think {
    ...
    protected $rollPage   ;
	// 分页显示定制
    protected $config  =    array('header'=>'条记录','prev'=>'上一页','next'=>'下一页','first'=>'第一页','last'=>'最后一页','theme'=>'共 %totalRow% %header% ,当前第%nowPage%/%totalPage%页,每页%listRows%条记录   %upPage%  %linkPage% %downPage%');
