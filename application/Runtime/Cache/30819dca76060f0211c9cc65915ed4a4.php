...
<title>区县年度信息汇总—<?php echo C('SITE_SUBJECT');?></title>
              ...
              <td><table width="96%" border="0" align="center" cellpadding="0" cellspacing="0" class="right3">
                ...
                <tr>
                  <td><table width="100%" border="0" cellspacing="1" cellpadding="0" style="background-color:#cccccc;">
                    ...
                    <tr class="right22">
                      <td width="25%" align="center" bgcolor="#FFFFFF" style="background-image:url(__PUBLIC__/images/tab-bj.gif)">区县标识码</td>
                      <td width="25%" align="center" bgcolor="#FFFFFF" style="background-image:url(__PUBLIC__/images/tab-bj.gif)">区县名称</td>
                      <td width="25%" align="center" bgcolor="#FFFFFF" style="background-image:url(__PUBLIC__/images/tab-bj.gif)">汇总年度</td>
                      <td  colspan="2" align="center" bgcolor="#FFFFFF" style="background-image:url(__PUBLIC__/images/tab-bj.gif)">操作</td>
                      </tr>
