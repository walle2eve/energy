...
<title>能源消耗数据查看-<?php echo C('SITE_SUBJECT');?></title>
<style>
                ...
                <tr>
                  <td align="center"><table width="96%" border="0" align="center" cellpadding="0" cellspacing="0"  style="font-size:14px;">
                    <tr>
                      ...
                      <td>单位名称：<strong><?php echo ($info["school_name"]); ?></strong></td>
                      <td>&nbsp;</td>
                      <td>区县：<?php echo ($info["town_name"]); ?></td>
                    </tr>
                    <tr>
                      <td>数据时段：<?php echo ($info["yearStr"]); ?></td>
                      <td>学校标识码：<?php echo ($info["school_code"]); ?></td>
