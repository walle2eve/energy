...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
	...
	<?php if(($user_kind) == "301010"): ?><a href="<?php echo U('Main/setStandard');?>" target="main">设置达标标准</a>&nbsp;&nbsp;<?php endif; if($user_kind == 301010 OR $user_kind == 301020): ?><a href="<?php echo U('Main/manager');?>" target="main">用户管理</a>&nbsp;&nbsp;<?php endif; ?>
