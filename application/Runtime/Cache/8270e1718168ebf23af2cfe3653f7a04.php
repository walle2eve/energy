          ...
          <table width="94%" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
              <td bgcolor="#FFFFFF"><table width="96%" border="0" align="center" cellpadding="0" cellspacing="0" class="right3">
                ...
                <tr>
                  <td height="36" class="right1">选择数据排序方式</td>
                </tr>
                <tr>
                  <td height="54"></td>
                </tr>
			<form action="<?php echo U('Main/orderby');?>" method="get" NAME="changeForm">
			<input type="hidden" name="town" value="<?php echo ($town); ?>">
                <tr>
				  <td height="104" align="center">
				  <b><input type="radio" name="ct" value='unit' checked/>按单位排序</b>

				  <b style="margin-left:150px"><input type="radio" name="ct" value='time' />按时间排序</b>
				  </td> 
                </tr>
                <tr>
                  <td height="54"></td>
