              ...
              <td align="left" bgcolor="#FFFFFF"><table width="840" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  ...
                  <td colspan="2" align="right">办学类型
                    <label>
					<?php if(($ac) == "edit"): ?><input type="text" style="width:200px;" value="<?php echo ($info["school_type_name"]); ?>" disabled=true>
					<?php else: ?>
                ...
                <tr>
                  <td height="30" colspan="2" align="right">学校名称
				  	<?php if(($ac) == "edit"): ?><input type="text" style="width:200px;" value="<?php echo ($info["school_name"]); ?>" disabled=true>
					<?php else: ?>
                  ...
                  <td colspan="2" align="right">学校或单位标识码
                    <label>
					<?php if(($ac) == "edit"): ?><input type="text" value = '<?php echo ($info["school_code"]); ?>' style="width:200px;" disabled=true />
					<?php else: ?>
