          ...
          <table width="94%" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
              <td bgcolor="#FFFFFF"><table width="96%" border="0" align="center" cellpadding="0" cellspacing="0" class="right3">
                ...
                <tr>
                  <td height="44" class="right2" width="100" align="center">选择数据排序项</td>
                </tr>
				<form action="<?php echo U('Main/orderby_show');?>" method="post" name="form_info_unit" onsubmit="return checkForm()" target="_blank">
				<tr>
				<td height="300">
