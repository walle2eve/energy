...
<title>上报信息查看——<?php echo C('SITE_SUBJECT');?></title>
<style>
      ...
      <tr>
        <td height="62" style="background-image:url(__PUBLIC__/images/right-bj.gif)"><table width="96%" border="0" align="right" cellpadding="0" cellspacing="0">
          <tr>
            ...
            <td width="62%" height="60" style="color:#43860C; font-size:16px; font-weight:bold;"><?php echo C('SITE_SUBJECT');?></td>
            <td align="" valign="bottom" style="color:#43860C; font-size:16px; font-weight:bold;">
			<a href="<?php echo U('Main/addInfo');?>"><img src="__PUBLIC__/images/sbsj.gif" width="137" height="41" border="0"></a>
			<?php if($user_kind == 301010 OR $user_kind == 301020): ?><a href="<?php echo U('Manager/showAddStatus');?>"><img src="__PUBLIC__/images/sbsj2.gif" width="137" height="41" border="0"></a><?php endif; ?>
			</td>
          </tr>
        </table></td>
      </tr>
              ...
              <td><table width="96%" border="0" align="center" cellpadding="0" cellspacing="0" class="right3">
                ...
                <tr>
                  <td><table width="100%" border="0" cellspacing="1" cellpadding="0" style="background-color:#cccccc;">
                    <tr class="right22">
                      <td colspan="8" height="36" align="left" bgcolor="#FFFFFF"><select onchange="selYears(this.value)"><option value="">--按时间查看--</option><?php echo ($years); ?></select></td>
                      </tr>
                    <tr class="right22">
